...
export default memo(function HeaderItems({ setOpenMenu, searchBar, cartLength, setSearchBar }) {
    return <>
        <div className='flex h-[60px] items-center gap-[25px] z-60'>
            ...
            <button onClick={ () => setOpenMenu(e => !e) } className='hidden md:block'>
